...
8. การรองรับเสียงอ่าน (Text-to-Speech):
   - เนื้อหาต้องกระชับ (ไม่เกิน 2-3 ประโยคต่อหน้า) ใช้เครื่องหมายวรรคตอน (, . ?) ให้ถูกต้องเพื่อให้เสียงอ่านเว้นจังหวะได้ดี
   - ห้ามใช้รูปแบบตาราง (Table) เด็ดขาด ให้เปลี่ยนเป็น Bullet points (-) แทน
   - หากเป็นการ์ดคำศัพท์ภาษาต่างประเทศ ให้ใช้ภาษานั้นล้วนๆ ในหน้าใดหน้าหนึ่ง เพื่อให้ระบบเลือกสำเนียงเสียงอ่านได้ถูกต้อง
            ...
            <form onSubmit={handleImportSubmit} className="space-y-4">
              <div className={`p-3 rounded-xl border ${isDark ? 'bg-slate-800/50 border-slate-700' : 'bg-sky-50 border-sky-100'}`}>
                ...
                <div className={`text-[11px] p-3 rounded-lg break-all leading-relaxed border max-h-40 overflow-y-auto ${
                  ...
                  <br/>
                  <span className={isDark ? "text-purple-400" : "text-purple-600"}>8. Text-to-Speech: เนื้อหากระชับ (ไม่เกิน 2-3 ประโยค) ห้ามใช้ตารางให้ใช้ Bullet (-) แทน และแยกภาษาให้ชัดเจนเพื่อให้เสียงอ่านเว้นจังหวะและปรับสำเนียงได้ถูกต้อง</span>
                  <br/><br/>
